...
public class SwaggerConfig {
    ...
    @Bean
    public OpenAPI customOpenApi() { // this is custom open-ip
        return new OpenAPI()
                .info(getInfo())
    ...
    private Info getInfo() { // when we create a swagger documentation we are going to see this information
        return new Info()
    ...
    private OAuthFlows createOAuthFlows() {
        ...
        return new OAuthFlows()
                .authorizationCode(flow); // grant type, because UI included
    }
